...
def updateAuroraC():
    ...
    subprocess.call(["make", "clean"], cwd="/home/pi/Documents/i3dea/aurora-1.9.0")
    subprocess.call(["git", "pull", "origin", "master"], cwd="/home/pi/Documents/i3dea/aurora-1.9.0") #need ssh key for this
    subprocess.call(["sudo", "make", "install"], cwd="/home/pi/Documents/i3dea/aurora-1.9.0")
